...
; !function () {
    ...
    var e = window.layui && layui.define
        ...
        , o = "layui-this"
        , s = "laydate-disabled"
        , l = "Start date exceeds end date<br>Please Reset"
        , d = [100, 2e5]
    ...
    C.prototype = [],
                ...
                w(d).html(function () {
                    ...
                    return "datetime" === t.type && e.push('<span lay-type="datetime" class="laydate-btns-time">' + n.timeTips + "</span>"),
                        w.each(t.btns, function (e, r) {
                            var o = n.tools[r] || "btn";
                            t.range && "now" === r || (a && "clear" === r && (o = "cn" === t.lang ? "Reset" : "Reset"),
                ...
                i) : (l = l || r.value,
                    ...
                    "string" == typeof l && l ? i.EXP_IF.test(l) ? r.range ? (l = l.split(" " + r.range + " "),
                        ...
                        w.each([i.startDate, i.endDate], function (e, t) {
                            m(t, l[e], e)
                        })) : m(o, l) : (i.hint("Wrong date format<br>Must follow the format：<br>" + (r.range ? r.format + " " + r.range + " " + r.format : r.format) + "<br>Reset for you"),
        ...
        T.prototype.calendar = function (e) {
            ...
            if (l.year < d[0] && (l.year = d[0],
                r.hint("The minimum can only support to AD" + d[0] + "year")),
                l.year > d[1] && (l.year = d[1],
                    r.hint("Can only support up to AD" + d[1] + "year")),
                ...
                "cn" === s.lang ? (w(f[0]).attr("lay-type", "year").html(l.year + "Yr"),
                    w(f[1]).attr("lay-type", "month").html(l.month + 1 + "M")) : (w(f[0]).attr("lay-type", "month").html(m.month[l.month]),
                ...
                u && (s.range && (e ? r.endDate = r.endDate || {
                    ...
                    e && (r.listYM = [[r.startDate.year, r.startDate.month + 1], [r.endDate.year, r.endDate.month + 1]],
                        ...
                        "time" === s.type ? r.setBtnStatus("Time", w.extend({}, r.systemDate(), r.startTime), w.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))),
        ...
        T.prototype.setBtnStatus = function (e, t, n) {
            ...
            d && (t = t || i.startDate,
                ...
                e && a && i.hint("string" == typeof e ? l.replace(/date/g, e) : l))
        }
        ,
            ...
            var n = this
                ...
                , o = {
                    ...
                    confirm: function () {
                        if (a.range) {
                            if (!n.endDate)
                                return n.hint("Please select a date range first");
                            if (w(e).hasClass(s))
                                return n.hint("time" === a.type ? l.replace(/date/g, "time") : l)
                        } else if (w(e).hasClass(s))
                            return n.hint("Is not within the valid date or time range");
                        n.done(),
                            n.setValue(n.parse()).remove()
                    }
                };
