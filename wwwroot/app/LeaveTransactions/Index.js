...
function gridList() {
    ...
    $gridList.dataGrid({
        url: '/LeaveTransactions/GetClientGridJson',
        ...
        colModel: [
            ...
            {
                label: 'Reporting Date', name: 'ReportingDate', width: $(window).width() * 0.1, align: 'left',
                formatter: "date", formatoptions: { srcformat: 'Y-m-d ', newformat: 'Y-m-d ' }
            },
            {
...
function btn_edit() {
    ...
    $.modalOpen({
        ...
        url: "/LeaveTransactions/Form?keyValue=" + keyValue,
        width: "700px",
        height: "510px",
        callBack: function (iframeId) {
            top.frames[iframeId].submitForm();
...
function btn_details() {
    ...
    $.modalOpen({
        ...
        url: "/LeaveTransactions/Details?keyValue=" + keyValue,
        width: "700px",
        height: "550px",
        btn: null,
    });
